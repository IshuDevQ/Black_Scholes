...
The project uses the Black-Scholes model to calculate theoretical prices for European options. For real-market validation, the Goldman Sachs options dataset provides option quotes, strikes, maturities, implied volatility, and bid-ask prices.
...
This makes the model output directly comparable with observed option quotes.
